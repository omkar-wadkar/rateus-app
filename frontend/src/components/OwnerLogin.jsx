...
function OwnerLogin({ onSuccess, onSwitchView }) {
    ...
    try {
      ...
      if (response.ok) {
        if (data.user.role === 'owner') {
          ...
          setMessage('Access denied. Store Owner login only.');
        }
      } else {
        ...
        <div className="container-fluid px-4">
          <div className="row justify-content-center">
            <div className="col-md-6 col-lg-4">
              <h1 className="text-center mb-4 display-4 text-white">Store Owner Login</h1>
